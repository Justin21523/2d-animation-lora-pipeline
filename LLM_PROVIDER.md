...
# OPTION A: Two-stage YOLO + SAM/ToonOut (RECOMMENDED - faster, efficient)
# For 3D animation: use MobileSAM
python scripts/generic/segmentation/yolo_sam_segmentation.py \
  --input-dir .../frames \
...
# OPTION B: SAM2 Instance Segmentation (ALTERNATIVE - more thorough)
# IMPORTANT: Always use --use-async-io with optimized parameters for >75% GPU utilization
...
- `.llm_provider/llm_provider.md` - **Extended project instructions and pipeline details** (primary reference)
