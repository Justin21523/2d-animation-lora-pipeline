...
const project = {
  "slug": "2d-animation-lora-pipeline",
  ...
  "githubUrl": "https://github.com/Justin21523/2d-animation-lora-pipeline",
  "readmeUrl": "https://github.com/Justin21523/2d-animation-lora-pipeline#readme",
  ...
  "features": [
    "Detected technical signals: Python, PyTorch, Diffusers, kohya-ss, PEFT (LoRA), Stable Diffusion / SDXL, ControlNet, Ultralytics YOLO, ByteTrack, DWpose, HDBSCAN, OmegaConf, GitHub Pages, Docker,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
    "I split the project into a real workstation workflow and a public demo layer",
    "The real path keeps YOLO, ToonOut, DWpose, HDBSCAN, kohya/diffusers, and local model/data warehouses",
    "The public path adds a static mock-safe demo with deterministic synthetic assets: stage dashboard, character dataset sheet, frame-to-sample transformation, training metrics, evaluation matrix, motion strip, screenshots, and a WebM walkthrough"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, PyTorch, Diffusers, kohya-ss, PEFT (LoRA), Stable Diffusion / SDXL, ControlNet, Ultralytics YOLO, ByteTrack, DWpose, HDBSCAN, OmegaConf, GitHub Pages, Docker,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "I split the project into a real workstation workflow and a public demo layer",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "The real path keeps YOLO, ToonOut, DWpose, HDBSCAN, kohya/diffusers, and local model/data warehouses",
      "status": "Queued",
      "owner": "Automation"
    },
    {
      "id": "flow-04",
      "name": "The public path adds a static mock-safe demo with deterministic synthetic assets: stage dashboard, character dataset sheet, frame-to-sample transformation, training metrics, evaluation matrix, motion strip, screenshots, and a WebM walkthrough",
      "status": "Ready",
      "owner": "Product"
    }
  ]
