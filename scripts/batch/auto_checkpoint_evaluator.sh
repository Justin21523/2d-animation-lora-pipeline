...
# Example: bash scripts/batch/auto_checkpoint_evaluator.sh /mnt/c/ai_models/diffusion/lora/sdxl/coco/miguel_identity miguel
#
...
if [ $# -lt 2 ]; then
    ...
    echo "Example: $0 /mnt/c/ai_models/diffusion/lora/sdxl/coco/miguel_identity miguel"
    exit 1
fi
