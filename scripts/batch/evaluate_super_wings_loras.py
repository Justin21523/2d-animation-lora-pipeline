...
colors, and personalities (referencing docs/projects/super-wings/).
...
# Paths
LORA_BASE_DIR = Path("/mnt/c/ai_models/diffusion/lora/sdxl/super-wings")
...
def main():
    ...
    print(f"   cp /mnt/c/ai_models/diffusion/lora/sdxl/super-wings/CHARACTER/BEST.safetensors \\")
    print(f"      /mnt/c/ai_models/diffusion/lora/sdxl/production/")
