...
output_dir = "/mnt/c/ai_models/diffusion/lora/sdxl/{movie}/{character_name}_identity"
output_name = "{character_name}_lora_sdxl"
logging_dir = "/mnt/c/ai_models/diffusion/lora/sdxl/{movie}/{character_name}_identity/logs"
