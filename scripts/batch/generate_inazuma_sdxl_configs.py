...
# Base paths
BASE_DATASET_PATH = "/mnt/data/datasets/general/inazuma-eleven/lora_data/characters_augmented"
BASE_OUTPUT_PATH = "/mnt/c/ai_models/diffusion/lora/sdxl/inazuma-eleven"
BASE_MODEL_PATH = "/mnt/data/ai_data/models/sdxl/stable-diffusion-xl-base-1.0"
VAE_PATH = "/mnt/data/ai_data/models/sdxl/sdxl_vae.safetensors"
...
def generate_toml_config(character: Dict) -> str:
    ...
    dataset_name = character["dataset_name"]
    trigger = character["trigger"]
    canonical_name = character["canonical_name"]

    # Paths
    train_data_dir = f"{BASE_DATASET_PATH}/{dataset_name}"
...
min_snr_gamma = {TRAINING_CONFIG["min_snr_gamma"]}
...
def main():
    ...
    for char in CHARACTERS:
        ...
        print(f"  Dataset: {char['dataset_name']} (200 images)")
    ...
    print(f"  Total Steps: ~24,000 per character")
    print(f"  Estimated Time: ~8-10 hours per character")
    print()
    print("Next Steps:")
