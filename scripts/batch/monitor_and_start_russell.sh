...
check_giulia_checkpoints() {
    local checkpoint_dir="/mnt/c/ai_models/diffusion/lora/sdxl/luca/giulia_identity"
...
if cd /mnt/c/ai_projects/kohya_ss/sd-scripts && \
   ...
   --config_file /mnt/c/ai_projects/3d-animation-lora-pipeline/configs/training/character_loras_sdxl/up_russell_sdxl.toml; then
    ...
    echo ""
    echo "輸出檔案:"
    echo "  /mnt/c/ai_models/diffusion/lora/sdxl/up/russell_identity/russell_lora_sdxl-000001.safetensors (Epoch 1)"
    echo "  /mnt/c/ai_models/diffusion/lora/sdxl/up/russell_identity/russell_lora_sdxl.safetensors (Epoch 2)"
    echo ""
