...
OUTPUT_DIR="/mnt/c/ai_models/diffusion/lora/sdxl/coco/miguel_identity"
...
EOF
        ...
        find /mnt/c/ai_models/diffusion/lora/sdxl/ -name ".training_complete" -delete 2>/dev/null || true
        echo "✅ 訓練標記已清除"
