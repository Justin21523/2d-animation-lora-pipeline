...
echo "  - Luca:    /mnt/c/ai_models/diffusion/lora/sdxl/luca/luca_identity/sdxl_trial1/luca_sdxl_RECOMMENDED.safetensors"
echo "  - Alberto: /mnt/c/ai_models/diffusion/lora/sdxl/luca/alberto_identity/alberto_identity_lora_sdxl-000002.safetensors"
echo ""
echo "================================================================================"
echo ""
...
# Verify file exists
if [ ! -f "/mnt/c/ai_models/diffusion/lora/sdxl/luca/alberto_identity/alberto_identity_lora_sdxl-000002.safetensors" ]; then
...
conda run -n ai_env python "$PROJECT_ROOT/scripts/evaluation/sdxl_multi_lora_compositor.py" \
    --loras /mnt/c/ai_models/diffusion/lora/sdxl/luca/alberto_identity/alberto_identity_lora_sdxl-000002.safetensors \
    --lora-names alberto \
...
# Verify file exists
if [ ! -f "/mnt/c/ai_models/diffusion/lora/sdxl/luca/luca_identity/sdxl_trial1/luca_sdxl_RECOMMENDED.safetensors" ]; then
...
conda run -n ai_env python "$PROJECT_ROOT/scripts/evaluation/sdxl_multi_lora_compositor.py" \
    --loras /mnt/c/ai_models/diffusion/lora/sdxl/luca/luca_identity/sdxl_trial1/luca_sdxl_RECOMMENDED.safetensors \
    --lora-names luca \
    --weight-combos "0.6" "0.8" "1.0" "1.2" \
