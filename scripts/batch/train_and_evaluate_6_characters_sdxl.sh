...
declare -a CHARACTERS=(
    "orion:configs/training/character_loras_sdxl/orion_orion_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/orion/orion_identity:orion"
    "ian:configs/training/character_loras_sdxl/onward_ian_lightfoot_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/onward/ian_lightfoot_identity:ian_lightfoot"
    "russell:configs/training/character_loras_sdxl/up_russell_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/up/russell_identity:russell"
    "tyler:configs/training/character_loras_sdxl/turning-red_tyler_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/turning-red/tyler_identity:tyler"
    "barley:configs/training/character_loras_sdxl/onward_barley_lightfoot_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/onward/barley_lightfoot_identity:barley_lightfoot"
    "giulia:configs/training/character_loras_sdxl/luca_giulia_identity_sdxl.toml:/mnt/c/ai_models/diffusion/lora/sdxl/luca/giulia_identity:giulia"
)
