...
echo ""
echo "📁 模型輸出位置:"
echo "   /mnt/c/ai_models/diffusion/lora/sdxl/synthetic/universal_pose/"
echo "   /mnt/c/ai_models/diffusion/lora/sdxl/synthetic/universal_action/"
echo "   /mnt/c/ai_models/diffusion/lora/sdxl/synthetic/universal_expression/"
echo ""
echo "📝 訓練日誌:"
echo "   ${LOG_DIR}/"
echo ""
