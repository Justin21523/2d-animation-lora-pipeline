...
conda run -n ai_env python /mnt/c/ai_projects/3d-animation-lora-pipeline/scripts/evaluation/sdxl_multi_lora_compositor.py \
  --loras \
    /mnt/c/ai_models/diffusion/lora/sdxl/coco/miguel_identity/miguel_identity_lora_sdxl-000004.safetensors \
    /mnt/c/ai_models/diffusion/lora/sdxl/luca/alberto_identity/alberto_identity_lora_sdxl-000002.safetensors \
